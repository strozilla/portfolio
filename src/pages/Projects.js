		...
		<section id="projects" className="wrapper alt style2">
			...
			<section className="spotlight">
				...
				<div className="content">
					<h2>Definitely NOT Youtube</h2>
					<p>
						<a
							href="https://strozilla.github.io/searchvidz/"
							target="_blank"
							rel="noreferrer"
						>
				...
				<div className="content">
					...
					<p>
						<a
							...
							rel="noreferrer"
						>
							Simple. Sleek. Modern. Get More Downloads By Wowing
							Customers With A Captivating Landing Page
						</a>
					</p>
				</div>
			</section>
